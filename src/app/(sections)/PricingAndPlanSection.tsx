    ...
    <Container>
        <div className="mx-auto text-start md:text-center">
            ...
            <h2 className="text-3xl lg:text-4xl text-[#0d4a3a] font-semibold ">
                Flexible VA Packages for Every Need
            </h2>
    ...
    <Container className="flex items-center justify-center">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 w-full md:gap-8 py-10 md:py-5">
            {pricingCards.map((card) => (
                <Card className="flex-1 shadow-sm hover:bg-[#F3F3F4] cursor-pointer border border-[#CCCCCC] hover:border-[#0d4a3a]" key={card.title}>
                    <CardHeader className="pb-0">
                    <div className={`w-fit font-medium text-sm px-3 py-1 rounded-full mb-4 
                                        ${
                                            card.indication === "Best Value" 
                                            ? "bg-[#e4f5a9] text-black" 
                                            : card.indication === "Most Popular" 
                                            ? "bg-[#f5a9f2] text-black" 
                                            : card.indication === 'Budget Friendly'
                    ...
                    <div className="flex items-baseline mb-6">
                        ...
                        <span className="text-5xl font-bold text-[#1a3b80]">{card.price}</span>
                    ...
                    <CardFooter>
                        <Button className="w-full bg-[#0d4a3a] hover:bg-[#fcc811] text-white justify-between rounded-full">
                            Get Started
